...
<div class="bgimg" style="background-image: url('{{url('img/login_reg.jpg')}}');padding-bottom: 100px;">

  @include('partials.home_header')

<input type="hidden" id="gamesCount" value="{{count($userGames)}}">
  <div class="ui container" style="padding-top: 100px">
    <div class="ui segment" style="background: transparent;border: none;">
      ...
      <div class="ui gray label" style="float:right;">
          ...
          <span class="ui" style="margin-left:10px;margin-right:10px;">Games Remaining: <strong style="color:black;">{{(3 - count($userGames))}} of 3</strong></span>
  ...
  @for($i=0;$i<count($userGames);$i++)
    <div class="ui container" style="margin-top:50px;width:900px;">
        <div class="ui" style="background-color: #efefef ;border-radius: 20px">
            <span class="ui ribbon label red" style="margin-bottom: 10px;margin-top:20px;margin-left: 14px;"><h2>{{$userGames[$i]['gameFullName']}}</h2></span>
            <div style="padding: 50px">
                <div class="ui equal width form">
                    <div class="fields">
                        <div class="field">
                            <img src="{{$userGames[$i]['gameLogoPath']}}" class="ui image" style="height: 200px; border: 5px solid #ddd;border-radius: 7px;width: 200px;margin-left: 75px;">
                        </div>
                        <div class="field">
                          <div class="fields">
                            <div id="updateId" class="updateGame ui yellow button left labeled icon" data-gameId="{{$userGames[$i]['game_id']}}" style="margin-left:10px;">
                              Update <i class="icon paste"></i>
                            </div>
                              <div id="editId" class="editGame ui blue button left labeled icon" data-gameId="{{$userGames[$i]['game_id']}}" style="margin-left:10px;">
                                  Build <i class="icon cubes"></i>
                            </div>
                            <div id="deleteGameId" class="deleteGame ui red button left labeled icon" data-gameId="{{$userGames[$i]['game_id']}}" data-gameFullName="{{$userGames[$i]['gameFullName']}}" style="margin-left:10px;">
                              Delete <i class="icon trash"></i>
                            </div>
                          </div>
                          <div class="fields">
                            <div id="playId" class="playGame ui green button left labeled icon" data-gameId="{{$userGames[$i]['game_id']}}" data-gamePath="{{$userGames[$i]['gamePath']}}" style="margin-left:32px;">
                              Play <i class="icon game"></i>
                            </div>
                            <div id="exportGameId" class="exportGame ui grey button left labeled icon" data-gameId="{{$userGames[$i]['game_id']}}" style="margin-left:10px;padding: 10px;">
                          ...
                          <div class="fields">
                            <div class="ui labeled input" style="padding: 10px;">
                              ...
                              <input type="text" value="{{$userGames[$i]['gamePath']}}">
                            </div>
                          </div>
                        </div>
                    </div>
